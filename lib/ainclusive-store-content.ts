...
export const AINCLUSIVE_LANDING: Record<AInclusiveLocale, LandingCopy> = {
  ...
  ru: {
    ...
    subtitle:
      'Сфотографируйте или вставьте материалы урока, и AInclusive адаптирует их для учеников с особыми образовательными потребностями и для тех, кто сталкивается с языковым барьером — на iPhone, iPad и Mac. Доступно на английском, иврите и итальянском.',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'В интерфейсе приложения — английский, иврит (справа налево) и итальянский; язык урока выбирается для каждой задачи.',
      },
      {
