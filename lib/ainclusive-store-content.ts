...
export const AINCLUSIVE_LANDING: Record<AInclusiveLocale, LandingCopy> = {
  ...
  ru: {
    ...
    testimonialQuote:
      'Работа с приложением AInclusive оказалась по-настоящему вдохновляющей. Удобный интерфейс и творческий подход к ученикам с особыми потребностями впечатляют… Уверена, что это приложение поддержит учителей.',
    testimonialAttribution: 'Учитель специального образования, ранний пилот',
