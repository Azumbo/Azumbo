    ...
    faqs: [
      {
        ...
        answer:
          'Ciro.Map — бесплатная iOS цифровая платформа для Ciro Marina: локальная карта, категории, маршруты, температура моря, экстренные контакты и wallet карт лояльности.',
      },
      {
