...
const games: GameCard[] = [
  {
    ...
    href: 'https://azumbo.vercel.app/frogger',
  },
  {
    ...
    href: 'https://azumbo.vercel.app/Spaceinvaders',
  },
  {
    title: 'Pac-Man',
    description:
    ...
    href: 'https://azumbo.vercel.app/PacMan',
  },
];
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-3">
            {games.map((game) => (
              <Link
                key={game.title}
                href={game.href}
                className="group block border border-black bg-white p-4 transition-all duration-300 hover:scale-[1.02] hover:ring-2 hover:ring-blue-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
