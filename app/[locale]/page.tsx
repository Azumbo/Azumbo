    ...
    <main className="landing-shell min-h-[100dvh] overflow-x-hidden bg-white text-neutral-900 dark:bg-neutral-950 dark:text-neutral-100">
      ...
      <header className="site-header sticky top-0 z-40 border-b border-neutral-800 bg-neutral-950/80 px-[max(env(safe-area-inset-left),0px)] backdrop-blur supports-[backdrop-filter]:bg-neutral-950/60">
        <div className="site-header__row mx-auto flex max-w-5xl items-center gap-4 px-4 py-3">
          <nav className="site-header__nav site-header__nav--desktop shrink-0 items-center gap-5 text-sm">
            <a
              href="#games"
        ...
        <nav className="site-header__nav site-header__nav--mobile mx-auto max-w-5xl items-center justify-center gap-5 px-4 pb-3 text-sm">
          <a
            href="#games"
            className="rounded-md text-neutral-300 transition hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black dark:focus-visible:outline-white"
          >
