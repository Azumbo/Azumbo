...
export default function AzumboLanding({ params }: { params: { locale: string } }) {
  ...
  return (
    <main className="landing-shell min-h-[100dvh] overflow-x-hidden bg-white text-neutral-900 dark:bg-neutral-950 dark:text-neutral-100">
      ...
      {/* COMPACT DARK HEADER */}
      <header className="site-header sticky top-0 z-40 border-b border-neutral-800 bg-neutral-950/80 px-[max(env(safe-area-inset-left),0px)] backdrop-blur supports-[backdrop-filter]:bg-neutral-950/60">
        <div className="site-header__row mx-auto flex max-w-5xl items-center gap-4 px-4 py-3">
          <nav className="site-header__nav hidden shrink-0 items-center gap-5 text-sm md:flex">
            <a
              href="#games"
          ...
          <div className="site-header__brand min-w-0 flex-1">
            <div className="site-header__brandRow flex items-center gap-3 md:gap-4">
              <span className="site-header__line h-px flex-1 bg-neutral-700" aria-hidden="true" />
              <div className="site-header__logoWrap shrink-0 px-2 md:px-3">
                <img
          ...
          <div className="site-header__locale ml-auto flex shrink-0 gap-2 text-xs">
        ...
        <nav className="site-header__nav site-header__nav--mobile mx-auto flex max-w-5xl items-center justify-center gap-5 px-4 pb-3 text-sm md:hidden">
          <a
            href="#games"
            className="rounded-md text-neutral-300 transition hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black dark:focus-visible:outline-white"
          >
