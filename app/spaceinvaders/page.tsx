    ...
    <GameChrome
      ...
      footer={
        <a
          ...
          className="btn-ghost gpu-layer w-full text-center text-sm"
        >
          {ctaText}
        </a>
      }
    >
      ...
      {status === 'lose' && (
        <div className="mt-4 text-center">
          <p className="type-body">Game Over</p>
          <button type="button" className="btn-ghost gpu-layer mt-3" onClick={resetGame}>
            Restart
          </button>
        </div>
      )}
